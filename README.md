...
- `FRONTEND_URLS` - Frontend URLS for CORS as a comma delimited list (default: `http://localhost:5173`)
...
FRONTEND_URL=http://your-frontend-address,https://your-frontend-address
